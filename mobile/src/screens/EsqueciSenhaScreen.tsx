    ...
    return (
      <View className="flex-1 justify-center items-center bg-blue-50 px-6">
        <View className="bg-white rounded-2xl p-6 items-center">
          ...
          <Text className="text-2xl font-bold text-gray-900 mb-3 text-center">Email Enviado!</Text>
          <Text className="text-gray-600 text-center mb-6 text-sm">
            Verifique seu email para o link de redefinição de senha. O link expira em 1 hora.
          </Text>
          <TouchableOpacity
    ...
    <ScrollView className="flex-1 bg-blue-50">
      <View className="flex-1 justify-center min-h-screen px-6 py-12">
        <View className="mb-8">
          ...
          <Text className="text-2xl font-bold text-gray-900 mt-3">Recuperar Acesso</Text>
          <Text className="text-sm text-gray-600 mt-2">Digite seu email para receber um link de redefinição</Text>
        </View>
        ...
        >
          {loading ? (
            ...
            <Text className="text-base font-semibold text-white text-center">Enviar Link de Reset</Text>
          )}
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          className="mt-6 py-3"
        >
          <Text className="text-blue-600 font-semibold text-center text-base">← Voltar ao Login</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
